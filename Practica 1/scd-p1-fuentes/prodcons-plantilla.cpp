...
int primera_libre=0;          //Indice del vector de la primera celda libre ( numero de elementos del buffer)	
...
Semaphore mutua = 1;           //Semaforo para que no se solapen las hebras y evitar la exclusion mutua
